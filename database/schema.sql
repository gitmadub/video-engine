...
CREATE TABLE IF NOT EXISTS video_playback_sessions (
    ...
    client_proof_key TEXT NOT NULL DEFAULT '',
    playback_token_hash TEXT NOT NULL DEFAULT '',
    previous_playback_token_hash TEXT NOT NULL DEFAULT '',
    pulse_client_token_hash TEXT NOT NULL DEFAULT '',
    pulse_server_token_hash TEXT NOT NULL DEFAULT '',
    previous_pulse_client_token_hash TEXT NOT NULL DEFAULT '',
    previous_pulse_server_token_hash TEXT NOT NULL DEFAULT '',
    pulse_sequence INTEGER NOT NULL DEFAULT 0,
